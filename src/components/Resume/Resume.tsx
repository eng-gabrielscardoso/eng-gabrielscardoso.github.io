  ...
  return (
    <section className="min-h-screen p-4 flex flex-col gap-4 justify-center items-center bg-resume text-white" data-scroll-section>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Front-end</summary>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Back-end</summary>
          <ul className="grid grid-cols-12 place-items-center gap-2">
            {backend}
          </ul>
        </details>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Blockchain</summary>
          <ul className="grid grid-cols-12 place-items-center gap-2">
            {blockchain}
          </ul>
        </details>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Database</summary>
          <ul className="grid grid-cols-12 place-items-center gap-2">
            {database}
          </ul>
        </details>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Testing</summary>
          <ul className="grid grid-cols-12 place-items-center gap-2">
            {testing}
          </ul>
        </details>
      ...
      <div className="w-full md:w-1/2">
        <details>
          <summary className="text-slate-200 text-xl font-bold mb-2 hover:cursor-pointer">Other Tools</summary>
          <ul className="grid grid-cols-12 place-items-center gap-2">
            {otherTools}
          </ul>
        </details>
