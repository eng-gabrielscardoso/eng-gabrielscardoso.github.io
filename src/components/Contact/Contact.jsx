...
export default function Contact(props) {
  return (
    <section className="min-h-screen p-2 lg:p-24 flex flex-col lg:flex-row gap-4 justify-around lg:justify-center items-center bg-yellow-600 text-white" data-scroll-section>
