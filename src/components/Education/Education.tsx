    ...
    <div className="bg-slate-50 p-4 rounded hover:cursor-pointer" key={index}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex flex-col">
          ...
          <span>
            <strong>{education.institution}</strong> | {education.period}
          </span>
        </div>
      </div>
